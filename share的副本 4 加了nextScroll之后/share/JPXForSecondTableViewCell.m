...
- (void)layoutSubviews
{
    ...
    [_button2 setBackgroundImage:[UIImage imageNamed:@"2.png"] forState:UIControlEventTouchUpInside];
    
    [_button3 addTarget:self action:@selector(pressButton1:) forControlEvents:UIControlEventTouchUpInside];
    
    [_button3 setBackgroundImage:[UIImage imageNamed:@"2.png"] forState:UIControlEventTouchUpInside];
    
    [_button4 addTarget:self action:@selector(pressButton1:) forControlEvents:UIControlEventTouchUpInside];
    
    [_button4 setBackgroundImage:[UIImage imageNamed:@"2.png"] forState:UIControlEventTouchUpInside];
    
    [_button5 addTarget:self action:@selector(pressButton1:) forControlEvents:UIControlEventTouchUpInside];
    
    [_button5 setBackgroundImage:[UIImage imageNamed:@"2.png"] forState:UIControlEventTouchUpInside];
    ...
    _button3.frame = CGRectMake(100, 0, 90, 90);
    
    _button4.frame = CGRectMake(200, 0, 90, 90);
    
    _button5.frame = CGRectMake(300, 0, 90, 90);
